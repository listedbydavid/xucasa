...
export const users = pgTable("users", {
  ...
  primaryIntent: varchar("primary_intent"),
  onboardingCompleted: boolean("onboarding_completed").default(false),
  buyerProfileCompleted: boolean("buyer_profile_completed").default(false),
  homeownerProfileCompleted: boolean("homeowner_profile_completed").default(false),
