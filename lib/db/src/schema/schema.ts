...
// Insert Schemas
export const insertPropertySchema: z.ZodTypeAny = createInsertSchema(properties).omit({ id: true, createdAt: true });
export const insertSellLeadSchema: z.ZodTypeAny = createInsertSchema(sellLeads).omit({ id: true, createdAt: true });
export const insertBuyerProfileSchema: z.ZodTypeAny = createInsertSchema(buyerProfiles).omit({ id: true, createdAt: true });
export const insertBuyerMatchSchema: z.ZodTypeAny = createInsertSchema(buyerMatches).omit({ id: true, createdAt: true });
export const insertSellerPitchSchema: z.ZodTypeAny = createInsertSchema(sellerPitches).omit({ id: true, createdAt: true });
export const insertFavoriteListSchema: z.ZodTypeAny = createInsertSchema(favoriteLists).omit({ id: true, createdAt: true });
export const insertSavedPropertySchema: z.ZodTypeAny = createInsertSchema(savedProperties).omit({ id: true, createdAt: true });
export const insertSavedSearchSchema: z.ZodTypeAny = createInsertSchema(savedSearches).omit({ id: true, createdAt: true });
export const insertSearchHistorySchema: z.ZodTypeAny = createInsertSchema(searchHistory).omit({ id: true, createdAt: true });
export const insertUserHomeSchema: z.ZodTypeAny = createInsertSchema(userHomes).omit({ id: true, createdAt: true });
export const insertClientAgentLinkSchema: z.ZodTypeAny = createInsertSchema(clientAgentLinks).omit({ id: true, createdAt: true });
export const insertPropertyOfferSchema: z.ZodTypeAny = createInsertSchema(propertyOffers).omit({ id: true, createdAt: true, updatedAt: true });
export const insertSwipeNotificationSchema: z.ZodTypeAny = createInsertSchema(swipeNotifications).omit({ id: true, createdAt: true });
export const insertPropertyReviewSchema: z.ZodTypeAny = createInsertSchema(propertyReviews).omit({ id: true, createdAt: true });
export const insertAgentContactSchema: z.ZodTypeAny = createInsertSchema(agentContacts).omit({ id: true, createdAt: true, updatedAt: true });
export const insertContactTagSchema: z.ZodTypeAny = createInsertSchema(contactTags).omit({ id: true, createdAt: true });
export const insertContactTagAssignmentSchema: z.ZodTypeAny = createInsertSchema(contactTagAssignments).omit({ id: true });
...
export const insertErrorReportSchema: z.ZodTypeAny = createInsertSchema(errorReports).omit({ id: true, firstSeen: true, lastSeen: true });
...
export const insertNotificationSchema: z.ZodTypeAny = createInsertSchema(notifications).omit({ id: true, createdAt: true });
...
export const insertBuyerInterestSchema: z.ZodTypeAny = createInsertSchema(buyerInterest).omit({ id: true, createdAt: true });
...
export const insertShowingRequestSchema: z.ZodTypeAny = createInsertSchema(showingRequests).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertAuditEventSchema: z.ZodTypeAny = createInsertSchema(auditEvents).omit({ id: true, createdAt: true });
...
export const insertSellerConcessionSchema: z.ZodTypeAny = createInsertSchema(sellerConcessions).omit({
  id: true,
  propertyId: true,
  postedByUserId: true,
  postedByRole: true,
...
export const insertPasswordResetTokenSchema: z.ZodTypeAny = createInsertSchema(passwordResetTokens).omit({ id: true, createdAt: true });
...
export const insertTourProgressSchema: z.ZodTypeAny = createInsertSchema(tourProgress).omit({ id: true, createdAt: true, updatedAt: true });
export const insertTourStepOverrideSchema: z.ZodTypeAny = createInsertSchema(tourStepOverrides).omit({ id: true, createdAt: true, updatedAt: true });
export const insertPageTipDismissedSchema: z.ZodTypeAny = createInsertSchema(pageTipsDismissed).omit({ id: true, dismissedAt: true });
export const insertFeatureChangelogSchema: z.ZodTypeAny = createInsertSchema(featureChangelog).omit({ id: true, createdAt: true });
export const insertChangelogViewSchema: z.ZodTypeAny = createInsertSchema(changelogViews).omit({ id: true, lastViewedAt: true });
...
export const insertLenderProfileSchema: z.ZodTypeAny = createInsertSchema(lenderProfiles).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertVendorProfileSchema: z.ZodTypeAny = createInsertSchema(vendorProfiles).omit({ id: true, createdAt: true, updatedAt: true });
export const insertPartnerInquirySchema: z.ZodTypeAny = createInsertSchema(partnerInquiries).omit({ id: true, createdAt: true });
